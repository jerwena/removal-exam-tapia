...
<div class="container">
    ...
    <tbody>
        ...
        <tr>
            <td style=" background-color: rgb(7, 8, 34);">{{ $guestbook->id }}</td>
            <td style=" background-color: rgb(7, 8, 34);">{{ $guestbook->full_name }}</td>
            <td style=" background-color: rgb(7, 8, 34);">{{ $guestbook->email_address }}</td>
            <td style=" background-color: rgb(7, 8, 34);">{{ $guestbook->age }}</td>
            <td style=" background-color: rgb(7, 8, 34);">{{ $guestbook->message }}</td>
        </tr>
         @endforeach
    </tbody>
    </table>
