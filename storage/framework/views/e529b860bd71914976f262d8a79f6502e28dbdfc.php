...
/* .... */
    ...
    <body class="antialiased">
        <div class="relative flex items-top justify-center min-h-screen bg-gray-100 dark:bg-gray-900 sm:items-center py-4 sm:pt-0">
            ...
            <?php endif; ?>
<<div class="container">
    <h1><strong>WELCOME TO<br>GUEST BOOK</strong></h1>
        <hr><br>
<div class="form-group">
        <label>Click to Register form:</label>
    <br>
...
<div class="form-group">
    ...
    <br>
    <a href="/guest-book-forms">
        <button type="submit" class="sumbit1">Click Here</button>
    </a>
</div>
    <br><br><hr>
...
</html><?php /**PATH C:\jerwena_project_laravel\resources\views/welcome.blade.php ENDPATH**/ ?>